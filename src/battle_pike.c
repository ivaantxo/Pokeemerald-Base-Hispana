...
{
    {EC_WORD_I_AM, EC_WORD_I_AM, EC_WORD_GIVE_ME, EC_WORD_A, EC_MOVE2(HELPING_HAND), EC_WORD_EXCL},
    {EC_WORD_HIM, EC_WORD_LOST, EC_WORD_YOU_RE, EC_EMPTY_WORD, EC_WORD_LOST, EC_WORD_QUES},
    {EC_WORD_THAT, EC_WORD_GIVE_ME, EC_WORD_NOW, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_IT_S, EC_WORD_A, EC_WORD_EXCITING, EC_WORD_FOR, EC_WORD_ME, EC_WORD_EXCL},
    {EC_WORD_WHOM, EC_MOVE2(HELPING_HAND), EC_WORD_AN, EC_EMPTY_WORD, EC_WORD_MISTAKE, EC_WORD_QUES},
    {EC_WORD_IT_S, EC_WORD_EXCL, EC_WORD_RECOMMEND, EC_WORD_MEAN, EC_WORD_THERE, EC_WORD_EXCL},
    {EC_WORD_NEED, EC_WORD_HIM, EC_WORD_WONDER, EC_WORD_AN, EC_WORD_NAP, EC_WORD_ELLIPSIS},
    {EC_WORD_SOMEONE, EC_WORD_ALSO, EC_WORD_A_LOT, EC_WORD_THIS, EC_WORD_CHALLENGE, EC_WORD_EXCL},
    {EC_WORD_LOOKS, EC_WORD_YOU_RE, EC_WORD_WILL, EC_EMPTY_WORD, EC_WORD_WIN, EC_WORD_ELLIPSIS},
    {EC_WORD_READY, EC_EMPTY_WORD, EC_WORD_GIVE_UP, EC_WORD_MY, EC_WORD_SMALL, EC_WORD_QUES},
    {EC_WORD_OH, EC_WORD_LOST, EC_WORD_WHO, EC_WORD_ELLIPSIS, EC_WORD_DOES, EC_WORD_QUES},
    {EC_WORD_I_AM, EC_WORD_QUES, EC_WORD_SINCE, EC_WORD_MOOD, EC_WORD_DAYS, EC_WORD_ELLIPSIS},
    {EC_WORD_I, EC_WORD_THAT, EC_WORD_THAT, EC_WORD_WILL, EC_WORD_GIVE_UP, EC_WORD_EXCL},
    {EC_WORD_THAT, EC_WORD_MAKE, EC_WORD_MAKE, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I, EC_WORD_NOW, EC_WORD_WIN, EC_WORD_WITH, EC_WORD_FEELING, EC_MOVE(SHEER_COLD)},
    {EC_WORD_I, EC_WORD_QUES, EC_WORD_LISTEN, EC_WORD_OF, EC_WORD_COOL, EC_WORD_EXCL},
    {EC_WORD_FIGHT, EC_EMPTY_WORD, EC_WORD_IT_S, EC_WORD_REALLY, EC_WORD_MEAN, EC_WORD_EXCL},
    {EC_WORD_TODAY, EC_EMPTY_WORD, EC_WORD_I_AM, EC_EMPTY_WORD, EC_WORD_WEAK, EC_WORD_ELLIPSIS},
    {EC_WORD_THE, EC_WORD_IT_S, EC_WORD_IS, EC_EMPTY_WORD, EC_WORD_GREAT, EC_WORD_EXCL_EXCL},
    {EC_WORD_NOT, EC_WORD_RECOMMEND, EC_WORD_A, EC_WORD_OTHER, EC_WORD_TRAINER, EC_WORD_ELLIPSIS},
    {EC_WORD_I, EC_WORD_EXCITING, EC_WORD_THAT, EC_WORD_IT_S, EC_WORD_EVEN_SO, EC_WORD_LEFT},
    {EC_WORD_IT_S, EC_WORD_FOR, EC_WORD_SOON, EC_WORD_FEELING, EC_WORD_END, EC_WORD_QUES},
    {EC_WORD_IT_S, EC_WORD_ME, EC_WORD_RECOMMEND, EC_EMPTY_WORD, EC_WORD_EASY, EC_WORD_EXCL},
    {EC_WORD_APOLOGIZE, EC_WORD_EXCL, EC_MOVE2(TACKLE), EC_WORD_DAUGHTER, EC_MOVE(FOCUS_ENERGY), EC_WORD_EXCL},
    {EC_WORD_SURRENDER, EC_WORD_WHOM, EC_WORD_I, EC_EMPTY_WORD, EC_WORD_REFUSE, EC_WORD_EXCL},
    {EC_WORD_I_AM, EC_WORD_DIDN_T, EC_WORD_TOO_WEAK, EC_EMPTY_WORD, EC_WORD_TODAY, EC_WORD_ELLIPSIS},
    {EC_WORD_I, EC_WORD_AN, EC_WORD_COULD, EC_WORD_PLUS, EC_WORD_WHO_WAS, EC_WORD_WHEN_I_WIN},
    {EC_WORD_A, EC_EMPTY_WORD, EC_WORD_FOREVER, EC_EMPTY_WORD, EC_WORD_MISS, EC_WORD_OTHER},
    {EC_WORD_CASE, EC_WORD_MISTAKE, EC_WORD_STEEL, EC_WORD_ELLIPSIS, EC_WORD_IT_S, EC_WORD_AWESOME},
    {EC_WORD_THERE, EC_WORD_QUES, EC_WORD_I_AM, EC_WORD_THE, EC_WORD_BEST, EC_WORD_TRAINER},
    {EC_WORD_IT_S, EC_WORD_IT_S, EC_WORD_BUT, EC_WORD_IT_S, EC_WORD_ENTERTAINING, EC_WORD_EXCL_EXCL},
    {EC_WORD_AND, EC_WORD_REALLY, EC_WORD_FOREVER, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_I_AM, EC_WORD_RECOMMEND, EC_WORD_CONFUSED, EC_WORD_ELLIPSIS, EC_EMPTY_WORD, EC_EMPTY_WORD},
    {EC_WORD_GOOD_BYE, EC_WORD_MEAN, EC_WORD_WILL, EC_WORD_EVEN_SO, EC_WORD_FEELING, EC_WORD_HOME},
    {EC_WORD_IT_S, EC_WORD_THERE, EC_WORD_NO_MATCH, EC_EMPTY_WORD, EC_WORD_THERE, EC_WORD_EXCL},
    {EC_WORD_A, EC_WORD_EXCL, EC_WORD_IT_S, EC_WORD_PROBABLY, EC_WORD_EXCITING, EC_WORD_EXCL},
    {EC_WORD_I_AM, EC_WORD_NEED, EC_WORD_THAT, EC_WORD_IT_S, EC_WORD_EVEN_SO, EC_WORD_RIGHT},
    {EC_WORD_NO, EC_EMPTY_WORD, EC_WORD_IT_S, EC_WORD_NOT, EC_WORD_JUST, EC_WORD_ELLIPSIS},
    {EC_WORD_WHO_IS, EC_WORD_WONDER, EC_WORD_ARE, EC_WORD_VERY, EC_WORD_NEVER, EC_WORD_EXCL},
    {EC_WORD_WHO_IS, EC_WORD_AN, EC_WORD_ARE, EC_WORD_VERSUS, EC_WORD_THE, EC_WORD_POISON},
    {EC_WORD_LALALA, EC_WORD_NAP, EC_WORD_I_AM, EC_WORD_THIN, EC_WORD_LALALA, EC_WORD_EXCL},
    {EC_MOVE2(TOXIC), EC_WORD_ELLIPSIS, EC_WORD_REALLY, EC_EMPTY_WORD, EC_WORD_AWFUL, EC_WORD_EXCL},
};
