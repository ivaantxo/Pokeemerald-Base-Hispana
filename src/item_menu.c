...
static const struct MenuAction sItemMenuActions[] = {
    ...
    [ACTION_CHECK]             = {COMPOUND_STRING("Comprobar"), {ItemMenu_UseOutOfBattle}},
    [ACTION_WALK]              = {COMPOUND_STRING("Caminar"),   {ItemMenu_UseOutOfBattle}},
    [ACTION_DESELECT]          = {COMPOUND_STRING("Anular"),    {ItemMenu_Register}},
...
static void PrintItemDescription(int itemIndex)
{
    ...
    BagMenu_Print(WIN_DESCRIPTION, GetFontIdToFit(str, FONT_NORMAL, 0, WindowWidthPx(WIN_DESCRIPTION) - 9), str, 3, 1, 0, 0, 0, COLORID_NORMAL);
}
...
static void PrintTMHMMoveData(u16 itemId)
{
    ...
    else
    {
        ...
        BlitMenuInfoIcon(WIN_TMHM_INFO, GetMoveType(move), 0, 0);
