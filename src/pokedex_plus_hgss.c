...
static const u8 sText_Stats_MoveLevel[] = _("Nivel");
...
static const u8 sText_Stats_ERRATIC[] = _("Errático");
static const u8 sText_Stats_FLUCTUATING[] = _("Fluctuante");
...
static const u8 sText_Stats_eggGroup[] = _("Huevo G1:");
...
static const u8 sText_Stats_eggGroup_DRAGON[] = _("Dragón");
...
static const u8 sText_EVO_FRIENDSHIP[] = _("{UP_ARROW}{LV}, amistad elevada."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_DAY[] = _("{UP_ARROW}{LV}, amistad elevada, día."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_NIGHT[] = _("{UP_ARROW}{LV}, amistad elevada, noche."); // POR CAMBIAR
static const u8 sText_EVO_FRIENDSHIP_MOVE_TYPE[] = _("{UP_ARROW}{LV}, amistad elevada, mov. {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL[] = _("{UP_ARROW}{LV} a {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_TRADE[] = _("Intercambio."); // POR CAMBIAR
static const u8 sText_EVO_TRADE_ITEM[] = _("Intercambio con {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_ITEM[] = _("Usando {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_ATK_GT_DEF[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, Atq > Def."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_ATK_EQ_DEF[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, Atq = Def."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_ATK_LT_DEF[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, Atq < Def."); // POR CAMBIAR
...
static const u8 sText_EVO_LEVEL_NINJASK[] = _("{UP_ARROW}{LV} a {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_SHEDINJA[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, equipo<6, 1x POKéBALL."); // POR CAMBIAR
static const u8 sText_EVO_BEAUTY[] = _("{UP_ARROW}{LV}, belleza alta."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_FEMALE[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, si chica."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_MALE[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, si chico."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NIGHT[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, noche."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DAY[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, día."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DUSK[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, tarde."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD_DAY[] = _("{UP_ARROW}{LV} con {STR_VAR_2}, día."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD_NIGHT[] = _("{UP_ARROW}{LV} con {STR_VAR_2}, noche."); // POR CAMBIAR
static const u8 sText_EVO_MOVE[] = _("{UP_ARROW}{LV}, si sabe {STR_VAR_2}.");
static const u8 sText_EVO_MAPSEC[] = _("{UP_ARROW}{LV} en {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_MALE[] = _("{STR_VAR_2} en chico."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_FEMALE[] = _("{STR_VAR_2} en chica."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_RAIN[] = _("{UP_ARROW}{LV} a {STR_VAR_2} en lluvia.");
static const u8 sText_EVO_SPECIFIC_MON_IN_PARTY[] = _("{UP_ARROW}{LV} con {STR_VAR_2} en equipo."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[] = _("{UP_ARROW}{LV} con tipo sin. en equipo."); // POR CAMBIAR
static const u8 sText_EVO_TRADE_SPECIFIC_MON[] = _("Cambiado por {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_SPECIFIC_MAP[] = _("{UP_ARROW}{LV} en {STR_VAR_2}."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NATURE_AMPED[] = _("{UP_ARROW}{LV} a {STR_VAR_2}, naturaleza aguda."); // POR CAMBIAR
static const u8 sText_EVO_LEVEL_NATURE_LOW_KEY[] = _("{UP_ARROW}{LV} A {STR_VAR_2}, naturaleza grave."); // POR CAMBIAR
...
static const u8 sText_EVO_ITEM_NIGHT[] = _("Usando {STR_VAR_2} de noche."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_DAY[] = _("Usando {STR_VAR_2} de día."); // POR CAMBIAR
static const u8 sText_EVO_ITEM_HOLD[] = _("{UP_ARROW}{LV}, teniendo {STR_VAR_2}."); // POR CAMBIAR
...
static const u8 sText_EVO_ITEM_COUNT_999[] = _("{UP_ARROW}{LV} con 999 {STR_VAR_2} en la mochila."); // POR CAMBIAR
static const u8 sText_EVO_UNKNOWN[] = _("Método desconocido."); // POR CAMBIAR
...
static const u8 sText_EVO_OVERWORLD_STEPS[] = _("{UP_ARROW}{LV} después de {STR_VAR_2} pasos."); // POR CAMBIAR
...
static void PrintStatsScreenTextSmall(u8 windowId, const u8* str, u8 left, u8 top)
{
    ...
    AddTextPrinterParameterized4(windowId, GetFontIdToFit(str, FONT_SMALL, 0, WindowWidthPx(WIN_STATS_MOVES_DESCRIPTION - 1)), left, top, 0, 0, color, 0, str);
}
