...
{
    {
        ...
        .id = 0,
        .speechLost = {EC_WORD_NOT, EC_WORD_NOT, EC_WORD_MYSTERY, EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_EXCL},
    },
    {
        ...
        .id = 1,
        .speechLost = {EC_WORD_OKAY, EC_WORD_OF, EC_WORD_LOST, EC_WORD_ELLIPSIS, EC_WORD_I_AM, EC_WORD_TOO_WEAK},
    },
    {
        ...
        .id = 2,
        .speechLost = {EC_WORD_I_AM, EC_WORD_MYSTERY, EC_WORD_AND, EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_EXCL},
    },
    {
        ...
        .id = 3,
        .speechLost = {EC_WORD_IT_S, EC_WORD_I_VE, EC_WORD_RECOMMEND, EC_WORD_QUES, EC_EMPTY_WORD, EC_EMPTY_WORD},
    },
    {
        ...
        .id = 4,
        .speechLost = {EC_WORD_SHADY, EC_WORD_LOST, EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_ARRGH, EC_WORD_EXCL},
    },
    {
        ...
        .id = 5,
        .speechLost = {EC_WORD_WHERE, EC_WORD_EXCL, EC_WORD_HUSTLE, EC_WORD_EXCL, EC_WORD_HELLO, EC_WORD_EXCL},
    },
    {
        ...
        .id = 6,
        .speechLost = {EC_WORD_AN, EC_WORD_OKAY, EC_WORD_USELESS, EC_WORD_ELLIPSIS, EC_WORD_IT_S, EC_WORD_NOTHING},
    },
    {
        ...
        .id = 7,
        .speechLost = {EC_WORD_SHAKE, EC_WORD_I_VE, EC_WORD_BEAUTIFUL, EC_WORD_EXCL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    },
    {
        ...
        .id = 8,
        .speechLost = {EC_WORD_YOUR, EC_WORD_LOST, EC_WORD_THAN, EC_WORD_FEELING, EC_WORD_ROUGH_SKIN, EC_WORD_EXCL},
    },
    {
        ...
        .id = 9,
        .speechLost = {EC_WORD_I_AM, EC_WORD_ELLIPSIS, EC_WORD_SHREDDED, EC_EMPTY_WORD, EC_WORD_ARRGH, EC_WORD_EXCL},
    },
    {
        ...
        .id = 10,
        .speechLost = {EC_WORD_HER, EC_WORD_I_AM, EC_WORD_WHO_WAS, EC_EMPTY_WORD, EC_WORD_GO_HOME, EC_WORD_EXCL},
    },
    {
        ...
        .id = 11,
        .speechLost = {EC_WORD_IT_S, EC_WORD_TOO_WEAK, EC_WORD_NICE, EC_WORD_I_VE, EC_WORD_LOST, EC_WORD_EXCL},
    },
    {
        ...
        .id = 12,
        .speechLost = {EC_WORD_IF, EC_WORD_I_AM, EC_WORD_IT_S, EC_WORD_AN, EC_WORD_LOSS, EC_WORD_EXCL},
    },
    {
        ...
        .id = 13,
        .speechLost = {EC_WORD_I_AM, EC_WORD_CAME, EC_WORD_WEAK, EC_WORD_EXCL, EC_EMPTY_WORD, EC_EMPTY_WORD},
    },
    {
        ...
        .id = 14,
        .speechLost = {EC_WORD_I, EC_WORD_AND, EC_WORD_UNDERSTANDS, EC_WORD_NOT, EC_WORD_WHY, EC_WORD_ELLIPSIS},
    },
    {
        ...
        .id = 15,
        .speechLost = {EC_WORD_IT_S, EC_WORD_I_VE, EC_WORD_JUST, EC_EMPTY_WORD, EC_WORD_GWAH, EC_WORD_EXCL},
    },
};
