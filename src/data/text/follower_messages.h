...
static const u8 sHappyMsg21[] = _("¡{STR_VAR_1} parece con ansia!");
...
static const u8 sNeutralMsg09[] = _("¡{STR_VAR_1} baila muy bien!");
...
static const u8 sPensiveMsg16[] = _("{STR_VAR_1} miró hacia ti y\nasintió.");
static const u8 sPensiveMsg17[] = _("{STR_VAR_1} parece de los nervios…");
