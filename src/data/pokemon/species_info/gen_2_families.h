...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .iconSprite = gObjectEventPic_Chikorita, 
        FOOTPRINT(Chikorita)
        OVERWORLD(
            sPicTable_Chikorita,
            SIZE_32x32,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .iconSprite = gObjectEventPic_Bayleef, 
        FOOTPRINT(Bayleef)
        OVERWORLD(
            sPicTable_Bayleef,
            SIZE_32x32,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .iconSprite = gObjectEventPic_Cyndaquil, 
        FOOTPRINT(Cyndaquil)
        OVERWORLD(
            sPicTable_Cyndaquil,
            SIZE_32x32,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .iconSprite = gObjectEventPic_Quilava, 
        FOOTPRINT(Quilava)
        OVERWORLD(
            sPicTable_Quilava,
            SIZE_32x32,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .iconSprite = gObjectEventPic_Typhlosion, 
    ...
    [SPECIES_TYPHLOSION_HISUIAN] =
    {
        ...
        .iconSprite = gObjectEventPic_TyphlosionHisuian, 
        FOOTPRINT(Typhlosion)
        OVERWORLD(
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .iconSprite = gObjectEventPic_Totodile, 
        FOOTPRINT(Totodile)
        OVERWORLD(
            sPicTable_Totodile,
            SIZE_32x32,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .iconSprite = gObjectEventPic_Croconaw, 
        FOOTPRINT(Croconaw)
        OVERWORLD(
            sPicTable_Croconaw,
            SIZE_32x32,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .iconSprite = gObjectEventPic_Feraligatr, 
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .iconSprite = gObjectEventPic_Sentret, 
        FOOTPRINT(Sentret)
        OVERWORLD(
            sPicTable_Sentret,
            SIZE_32x32,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .iconSprite = gObjectEventPic_Furret, 
        FOOTPRINT(Furret)
        OVERWORLD(
            sPicTable_Furret,
            SIZE_32x32,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .iconSprite = gObjectEventPic_Hoothoot, 
        FOOTPRINT(Hoothoot)
        OVERWORLD(
            sPicTable_Hoothoot,
            SIZE_32x32,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .iconSprite = gObjectEventPic_Noctowl, 
        FOOTPRINT(Noctowl)
        OVERWORLD(
            sPicTable_Noctowl,
            SIZE_32x32,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .iconSprite = gObjectEventPic_Ledyba, 
        FOOTPRINT(Ledyba)
        OVERWORLD(
            sPicTable_Ledyba,
            SIZE_32x32,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .iconSprite = gObjectEventPic_Ledian, 
        FOOTPRINT(Ledian)
        OVERWORLD(
            sPicTable_Ledian,
            SIZE_32x32,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .iconSprite = gObjectEventPic_Spinarak, 
        FOOTPRINT(Spinarak)
        OVERWORLD(
            sPicTable_Spinarak,
            SIZE_32x32,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .iconSprite = gObjectEventPic_Ariados, 
        FOOTPRINT(Ariados)
        OVERWORLD(
            sPicTable_Ariados,
            SIZE_32x32,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .iconSprite = gObjectEventPic_Chinchou, 
        FOOTPRINT(Chinchou)
        OVERWORLD(
            sPicTable_Chinchou,
            SIZE_32x32,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .iconSprite = gObjectEventPic_Lanturn, 
        FOOTPRINT(Lanturn)
        OVERWORLD(
            sPicTable_Lanturn,
            SIZE_32x32,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .iconSprite = gObjectEventPic_Togepi, 
        FOOTPRINT(Togepi)
        OVERWORLD(
            sPicTable_Togepi,
            SIZE_32x32,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .iconSprite = gObjectEventPic_Togetic, 
        FOOTPRINT(Togetic)
        OVERWORLD(
            sPicTable_Togetic,
            SIZE_32x32,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .iconSprite = gObjectEventPic_Togekiss, 
        FOOTPRINT(Togekiss)
        OVERWORLD(
            sPicTable_Togekiss,
            SIZE_32x32,
    ...
    [SPECIES_NATU] =
    {
        ...
        .iconSprite = gObjectEventPic_Natu, 
        FOOTPRINT(Natu)
        OVERWORLD(
            sPicTable_Natu,
            SIZE_32x32,
    ...
    [SPECIES_XATU] =
    {
        ...
        .iconSprite = gObjectEventPic_Xatu, 
        FOOTPRINT(Xatu)
        OVERWORLD(
            sPicTable_Xatu,
            SIZE_32x32,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .iconSprite = gObjectEventPic_Mareep, 
        FOOTPRINT(Mareep)
        OVERWORLD(
            sPicTable_Mareep,
            SIZE_32x32,
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .iconSprite = gObjectEventPic_Flaaffy, 
        FOOTPRINT(Flaaffy)
        OVERWORLD(
            sPicTable_Flaaffy,
            SIZE_32x32,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .iconSprite = gObjectEventPic_Ampharos, 
        FOOTPRINT(Ampharos)
        OVERWORLD(
            sPicTable_Ampharos,
            SIZE_32x32,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .iconSprite = gObjectEventPic_Azurill, 
        FOOTPRINT(Azurill)
        OVERWORLD(
            sPicTable_Azurill,
            SIZE_32x32,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .iconSprite = gObjectEventPic_Marill, 
        FOOTPRINT(Marill)
        OVERWORLD(
            sPicTable_Marill,
            SIZE_32x32,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .iconSprite = gObjectEventPic_Azumarill, 
        FOOTPRINT(Azumarill)
        OVERWORLD(
            sPicTable_Azumarill,
            SIZE_32x32,
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .iconSprite = gObjectEventPic_Bonsly, 
        FOOTPRINT(Bonsly)
        OVERWORLD(
            sPicTable_Bonsly,
            SIZE_32x32,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .iconSprite = gObjectEventPic_Sudowoodo, 
        FOOTPRINT(Sudowoodo)
        OVERWORLD(
            sPicTable_Sudowoodo,
            SIZE_32x32,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .iconSprite = gObjectEventPic_Hoppip, 
        FOOTPRINT(Hoppip)
        OVERWORLD(
            sPicTable_Hoppip,
            SIZE_32x32,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .iconSprite = gObjectEventPic_Skiploom, 
        FOOTPRINT(Skiploom)
        OVERWORLD(
            sPicTable_Skiploom,
            SIZE_32x32,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .iconSprite = gObjectEventPic_Jumpluff, 
        FOOTPRINT(Jumpluff)
        OVERWORLD(
            sPicTable_Jumpluff,
            SIZE_32x32,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .iconSprite = gObjectEventPic_Aipom, 
        FOOTPRINT(Aipom)
        OVERWORLD(
            sPicTable_Aipom,
            SIZE_32x32,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .iconSprite = gObjectEventPic_Ambipom, 
        FOOTPRINT(Ambipom)
        OVERWORLD(
            sPicTable_Ambipom,
            SIZE_32x32,
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .iconSprite = gObjectEventPic_Sunkern, 
        FOOTPRINT(Sunkern)
        OVERWORLD(
            sPicTable_Sunkern,
            SIZE_32x32,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .iconSprite = gObjectEventPic_Sunflora, 
        FOOTPRINT(Sunflora)
        OVERWORLD(
            sPicTable_Sunflora,
            SIZE_32x32,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .iconSprite = gObjectEventPic_Yanma, 
        FOOTPRINT(Yanma)
        OVERWORLD(
            sPicTable_Yanma,
            SIZE_32x32,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .iconSprite = gObjectEventPic_Yanmega, 
        FOOTPRINT(Yanmega)
        OVERWORLD(
            sPicTable_Yanmega,
            SIZE_32x32,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .iconSprite = gObjectEventPic_Wooper, 
        FOOTPRINT(Wooper)
        OVERWORLD(
            sPicTable_Wooper,
            SIZE_32x32,
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .iconSprite = gObjectEventPic_Quagsire, 
        FOOTPRINT(Quagsire)
        OVERWORLD(
            sPicTable_Quagsire,
            SIZE_32x32,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .iconSprite = gObjectEventPic_Murkrow, 
        FOOTPRINT(Murkrow)
        OVERWORLD(
            sPicTable_Murkrow,
            SIZE_32x32,
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .iconSprite = gObjectEventPic_Honchkrow, 
        FOOTPRINT(Honchkrow)
        OVERWORLD(
            sPicTable_Honchkrow,
            SIZE_32x32,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .iconSprite = gObjectEventPic_Misdreavus, 
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .iconSprite = gObjectEventPic_Mismagius, 
        FOOTPRINT(Mismagius)
        OVERWORLD(
            sPicTable_Mismagius,
            SIZE_32x32,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .iconSprite = gObjectEventPic_Unown ##letter,                                                   \
        FOOTPRINT(Unown)                                                                                \
        OVERWORLD(                                                                                      \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .iconSprite = gObjectEventPic_Wynaut, 
        FOOTPRINT(Wynaut)
        OVERWORLD(
            sPicTable_Wynaut,
            SIZE_32x32,
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .iconSprite = gObjectEventPic_Girafarig, 
        FOOTPRINT(Girafarig)
        OVERWORLD(
            sPicTable_Girafarig,
            SIZE_32x32,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .iconSprite = gObjectEventPic_Pineco, 
        FOOTPRINT(Pineco)
        OVERWORLD(
            sPicTable_Pineco,
            SIZE_32x32,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .iconSprite = gObjectEventPic_Forretress, 
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .iconSprite = gObjectEventPic_Dunsparce, 
        FOOTPRINT(Dunsparce)
        OVERWORLD(
            sPicTable_Dunsparce,
            SIZE_32x32,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .iconSprite = gObjectEventPic_Gligar, 
        FOOTPRINT(Gligar)
        OVERWORLD(
            sPicTable_Gligar,
            SIZE_32x32,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .iconSprite = gObjectEventPic_Gliscor, 
        FOOTPRINT(Gliscor)
        OVERWORLD(
            sPicTable_Gliscor,
            SIZE_32x32,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .iconSprite = gObjectEventPic_Snubbull, 
        FOOTPRINT(Snubbull)
        OVERWORLD(
            sPicTable_Snubbull,
            SIZE_32x32,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .iconSprite = gObjectEventPic_Granbull, 
        FOOTPRINT(Granbull)
        OVERWORLD(
            sPicTable_Granbull,
            SIZE_32x32,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .iconSprite = gObjectEventPic_Qwilfish, 
        FOOTPRINT(Qwilfish)
        OVERWORLD(
            sPicTable_Qwilfish,
            SIZE_32x32,
    ...
    [SPECIES_QWILFISH_HISUIAN] =
    {
        ...
        .iconSprite = gObjectEventPic_QwilfishHisuian, 
        FOOTPRINT(Qwilfish)
        OVERWORLD(
    ...
    [SPECIES_OVERQWIL] =
    {
        ...
        .iconSprite = gObjectEventPic_Overqwil, 
        FOOTPRINT(Overqwil)
        OVERWORLD(
            sPicTable_Overqwil,
            SIZE_32x32,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .iconSprite = gObjectEventPic_Shuckle, 
        FOOTPRINT(Shuckle)
        OVERWORLD(
            sPicTable_Shuckle,
            SIZE_32x32,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .iconSprite = gObjectEventPic_Heracross, 
        FOOTPRINT(Heracross)
        OVERWORLD(
            sPicTable_Heracross,
            SIZE_32x32,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .iconSprite = gObjectEventPic_Sneasel, 
        FOOTPRINT(Sneasel)
        OVERWORLD(
            sPicTable_Sneasel,
            SIZE_32x32,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .iconSprite = gObjectEventPic_Weavile, 
        FOOTPRINT(Weavile)
        OVERWORLD(
            sPicTable_Weavile,
            SIZE_32x32,
    ...
    [SPECIES_SNEASEL_HISUIAN] =
    {
        ...
        .iconSprite = gObjectEventPic_SneaselHisuian, 
        FOOTPRINT(Sneasel)
        OVERWORLD(
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .iconSprite = gObjectEventPic_Sneasler, 
        FOOTPRINT(Sneasler)
        OVERWORLD(
            sPicTable_Sneasler,
            SIZE_32x32,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .iconSprite = gObjectEventPic_Teddiursa, 
        FOOTPRINT(Teddiursa)
        OVERWORLD(
            sPicTable_Teddiursa,
            SIZE_32x32,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .iconSprite = gObjectEventPic_Ursaring, 
        FOOTPRINT(Ursaring)
        OVERWORLD(
            sPicTable_Ursaring,
            SIZE_32x32,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .iconSprite = gObjectEventPic_Ursaluna, 
        FOOTPRINT(Ursaluna)
        OVERWORLD(
            sPicTable_Ursaluna,
            SIZE_32x32,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .iconSprite = gObjectEventPic_Slugma, 
        FOOTPRINT(Slugma)
        OVERWORLD(
            sPicTable_Slugma,
            SIZE_32x32,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .iconSprite = gObjectEventPic_Magcargo, 
        FOOTPRINT(Magcargo)
        OVERWORLD(
            sPicTable_Magcargo,
            SIZE_32x32,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .iconSprite = gObjectEventPic_Swinub, 
        FOOTPRINT(Swinub)
        OVERWORLD(
            sPicTable_Swinub,
            SIZE_32x32,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .iconSprite = gObjectEventPic_Piloswine, 
        FOOTPRINT(Piloswine)
        OVERWORLD(
            sPicTable_Piloswine,
            SIZE_32x32,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .iconSprite = gObjectEventPic_Mamoswine, 
        FOOTPRINT(Mamoswine)
        OVERWORLD(
            sPicTable_Mamoswine,
            SIZE_32x32,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .iconSprite = gObjectEventPic_Corsola, 
        FOOTPRINT(Corsola)
        OVERWORLD(
            sPicTable_Corsola,
            SIZE_32x32,
    ...
    [SPECIES_CORSOLA_GALARIAN] =
    {
        ...
        .iconSprite = gObjectEventPic_CorsolaGalarian, 
        FOOTPRINT(Corsola)
        OVERWORLD(
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .iconSprite = gObjectEventPic_Cursola, 
        FOOTPRINT(Cursola)
        OVERWORLD(
            sPicTable_Cursola,
            SIZE_32x32,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .iconSprite = gObjectEventPic_Remoraid, 
        FOOTPRINT(Remoraid)
        OVERWORLD(
            sPicTable_Remoraid,
            SIZE_32x32,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .iconSprite = gObjectEventPic_Octillery, 
        FOOTPRINT(Octillery)
        OVERWORLD(
            sPicTable_Octillery,
            SIZE_32x32,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .iconSprite = gObjectEventPic_Delibird, 
        FOOTPRINT(Delibird)
        OVERWORLD(
            sPicTable_Delibird,
            SIZE_32x32,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .iconSprite = gObjectEventPic_Mantyke, 
        FOOTPRINT(Mantyke)
        OVERWORLD(
            sPicTable_Mantyke,
            SIZE_32x32,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .iconSprite = gObjectEventPic_Mantine, 
        FOOTPRINT(Mantine)
        OVERWORLD(
            sPicTable_Mantine,
            SIZE_32x32,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .iconSprite = gObjectEventPic_Skarmory, 
        FOOTPRINT(Skarmory)
        OVERWORLD(
            sPicTable_Skarmory,
            SIZE_32x32,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .iconSprite = gObjectEventPic_Houndour, 
        FOOTPRINT(Houndour)
        OVERWORLD(
            sPicTable_Houndour,
            SIZE_32x32,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .iconSprite = gObjectEventPic_Houndoom, 
        FOOTPRINT(Houndoom)
        OVERWORLD(
            sPicTable_Houndoom,
            SIZE_32x32,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .iconSprite = gObjectEventPic_Phanpy, 
        FOOTPRINT(Phanpy)
        OVERWORLD(
            sPicTable_Phanpy,
            SIZE_32x32,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .iconSprite = gObjectEventPic_Donphan, 
        FOOTPRINT(Donphan)
        OVERWORLD(
            sPicTable_Donphan,
            SIZE_32x32,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .iconSprite = gObjectEventPic_Stantler, 
        FOOTPRINT(Stantler)
        OVERWORLD(
            sPicTable_Stantler,
            SIZE_32x32,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .iconSprite = gObjectEventPic_Wyrdeer, 
        FOOTPRINT(Wyrdeer)
        OVERWORLD(
            sPicTable_Wyrdeer,
            SIZE_32x32,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .iconSprite = gObjectEventPic_Smeargle, 
        FOOTPRINT(Smeargle)
        OVERWORLD(
            sPicTable_Smeargle,
            SIZE_32x32,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .iconSprite = gObjectEventPic_Miltank, 
        FOOTPRINT(Miltank)
        OVERWORLD(
            sPicTable_Miltank,
            SIZE_32x32,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .iconSprite = gObjectEventPic_Raikou, 
        FOOTPRINT(Raikou)
        OVERWORLD(
            sPicTable_Raikou,
            SIZE_32x32,
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .iconSprite = gObjectEventPic_Entei, 
        FOOTPRINT(Entei)
        OVERWORLD(
            sPicTable_Entei,
            SIZE_32x32,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .iconSprite = gObjectEventPic_Suicune, 
        FOOTPRINT(Suicune)
        OVERWORLD(
            sPicTable_Suicune,
            SIZE_32x32,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .iconSprite = gObjectEventPic_Larvitar, 
        FOOTPRINT(Larvitar)
        OVERWORLD(
            sPicTable_Larvitar,
            SIZE_32x32,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .iconSprite = gObjectEventPic_Pupitar, 
        FOOTPRINT(Pupitar)
        OVERWORLD(
            sPicTable_Pupitar,
            SIZE_32x32,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .iconSprite = gObjectEventPic_Tyranitar, 
        FOOTPRINT(Tyranitar)
        OVERWORLD(
            sPicTable_Tyranitar,
            SIZE_32x32,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .iconSprite = gObjectEventPic_Celebi, 
        FOOTPRINT(Celebi)
        OVERWORLD(
            sPicTable_Celebi,
            SIZE_32x32,
