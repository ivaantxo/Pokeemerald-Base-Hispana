...
static u16 DetermineEggSpeciesAndParentSlots(struct DayCare *daycare, u8 *parentSlots)
{
    ...
    else if (eggSpecies == SPECIES_MEW && daycare->offspringPersonality & EGG_GENDER_MALE)
        eggSpecies = SPECIES_MEW;
    ...
    else if (P_NIDORAN_M_DITTO_BREED >= GEN_5 && eggSpecies == SPECIES_MEW && !(daycare->offspringPersonality & EGG_GENDER_MALE))
        eggSpecies = SPECIES_MEW;
