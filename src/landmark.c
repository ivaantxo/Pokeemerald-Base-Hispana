...
static const struct Landmark Landmark_FlowerShop = {COMPOUND_STRING("FLORISTERÍA"), FLAG_LANDMARK_FLOWER_SHOP};
static const struct Landmark Landmark_PetalburgWoods = {COMPOUND_STRING("BOSQUE PETALIA"), -1};
static const struct Landmark Landmark_MrBrineysCottage = {COMPOUND_STRING("CASA del SR. ARENQUE"), FLAG_LANDMARK_MR_BRINEY_HOUSE};
static const struct Landmark Landmark_AbandonedShip = {COMPOUND_STRING("NAO ABANDONADA"), FLAG_LANDMARK_ABANDONED_SHIP};
static const struct Landmark Landmark_SeashoreHouse = {COMPOUND_STRING("CASA de la PLAYA"), FLAG_LANDMARK_SEASHORE_HOUSE};
static const struct Landmark Landmark_SlateportBeach = {COMPOUND_STRING("PLAYA de CDAD. PORTUAL"), -1};
static const struct Landmark Landmark_CyclingRoad = {COMPOUND_STRING("CAMINO de BICIS"), -1};
static const struct Landmark Landmark_NewMauville = {COMPOUND_STRING("MALVALANOVA"), FLAG_LANDMARK_NEW_MAUVILLE};
static const struct Landmark Landmark_TrickHouse = {COMPOUND_STRING("CASA TRETA"), FLAG_LANDMARK_TRICK_HOUSE};
static const struct Landmark Landmark_OldLadysRestShop = {COMPOUND_STRING("POSADA de la ABUELA"), FLAG_LANDMARK_OLD_LADY_REST_SHOP};
static const struct Landmark Landmark_Desert = {COMPOUND_STRING("DESIERTO"), -1};
static const struct Landmark Landmark_WinstrateFamily = {COMPOUND_STRING("La familia ESTRATEGA"), FLAG_LANDMARK_WINSTRATE_FAMILY};
static const struct Landmark Landmark_CableCar = {COMPOUND_STRING("TELEFÉRICO"), -1};
static const struct Landmark Landmark_GlassWorkshop = {COMPOUND_STRING("TALLER de VIDRIO"), FLAG_LANDMARK_GLASS_WORKSHOP};
static const struct Landmark Landmark_WeatherInstitute = {COMPOUND_STRING("INST. METEOROLÓGICO"), -1};
static const struct Landmark Landmark_MeteorFalls = {COMPOUND_STRING("CASCADA METEORO"), -1};
static const struct Landmark Landmark_TunnelersRestHouse = {COMPOUND_STRING("POSADA del TUNELERO"), FLAG_LANDMARK_TUNNELERS_REST_HOUSE};
static const struct Landmark Landmark_RusturfTunnel = {COMPOUND_STRING("TÚNEL FERVERGAL"), -1};
static const struct Landmark Landmark_PokemonDayCare = {COMPOUND_STRING("GUARDERÍA POKéMON"), FLAG_LANDMARK_POKEMON_DAYCARE};
static const struct Landmark Landmark_SafariZoneEntrance = {COMPOUND_STRING("ENTRADA al SAFARI"), -1};
static const struct Landmark Landmark_MtPyre = {COMPOUND_STRING("MONTE PÍRICO"), -1};
static const struct Landmark Landmark_ShoalCave = {COMPOUND_STRING("CUEVA CARDUMEN"), -1};
static const struct Landmark Landmark_SeafloorCavern = {COMPOUND_STRING("CAVERNA ABISAL"), FLAG_LANDMARK_SEAFLOOR_CAVERN};
static const struct Landmark Landmark_GraniteCave = {COMPOUND_STRING("CUEVA GRANITO"), -1};
static const struct Landmark Landmark_OceanCurrent = {COMPOUND_STRING("CORRIENTE OCEÁNICA"), -1};
static const struct Landmark Landmark_LanettesHouse = {COMPOUND_STRING("CASA de AREDIA"), FLAG_LANDMARK_LANETTES_HOUSE};
static const struct Landmark Landmark_FieryPath = {COMPOUND_STRING("SENDA ÍGNEA"), FLAG_LANDMARK_FIERY_PATH};
static const struct Landmark Landmark_JaggedPass = {COMPOUND_STRING("DESFILADERO"), -1};
static const struct Landmark Landmark_BerryMastersHouse = {COMPOUND_STRING("CASA del BAYÓLOGO"), FLAG_LANDMARK_BERRY_MASTERS_HOUSE};
static const struct Landmark Landmark_IslandCave = {COMPOUND_STRING("CUEVA INSULAR"), FLAG_LANDMARK_ISLAND_CAVE};
static const struct Landmark Landmark_DesertRuins = {COMPOUND_STRING("RUINAS DESIERTO"), FLAG_LANDMARK_DESERT_RUINS};
static const struct Landmark Landmark_ScorchedSlab = {COMPOUND_STRING("GRUTA SOLAR"), FLAG_LANDMARK_SCORCHED_SLAB};
static const struct Landmark Landmark_AncientTomb = {COMPOUND_STRING("TUMBA ANTIGUA"), FLAG_LANDMARK_ANCIENT_TOMB};
static const struct Landmark Landmark_SealedChamber = {COMPOUND_STRING("CÁMARA SELLADA"), FLAG_LANDMARK_SEALED_CHAMBER};
static const struct Landmark Landmark_FossilManiacsHouse = {COMPOUND_STRING("CASA del FOSILMANÍACO"), FLAG_LANDMARK_FOSSIL_MANIACS_HOUSE};
static const struct Landmark Landmark_HuntersHouse = {COMPOUND_STRING("CASA del BUSCATESOROS"), FLAG_LANDMARK_HUNTERS_HOUSE};
static const struct Landmark Landmark_SkyPillar = {COMPOUND_STRING("PILAR CELESTE"), FLAG_LANDMARK_SKY_PILLAR};
static const struct Landmark Landmark_MirageTower = {COMPOUND_STRING("TORRE ESPEJISMO"), FLAG_LANDMARK_MIRAGE_TOWER};
static const struct Landmark Landmark_AlteringCave = {COMPOUND_STRING("CUEVA CAMBIANTE"), FLAG_LANDMARK_ALTERING_CAVE};
static const struct Landmark Landmark_DesertUnderpass = {COMPOUND_STRING("GRUTA DESÉRTICA"), FLAG_LANDMARK_DESERT_UNDERPASS};
static const struct Landmark Landmark_TrainerHill = {COMPOUND_STRING("COLINA DESAFÍO"), FLAG_LANDMARK_TRAINER_HILL};
