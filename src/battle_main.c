...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_HIKER] = { _("MONTA�ERO"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_LEADER] = { _("L�DER"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_CHAMPION] = { _("CAMPE�N"), 50, BALL_ULTRA },
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = { _("DAMA TORRE"), 0, BALL_ULTRA },
