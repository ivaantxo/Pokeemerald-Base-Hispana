...
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2 y{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE 0x38}¡puf!\p");
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE 0x11}¡Escapaste sin problemas!\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE 0x11}¡{B_ATK_NAME_WITH_PREFIX} escapó\nusando su {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE 0x11}¡{B_ATK_NAME_WITH_PREFIX} escapó\nusando su {B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE 0x11}¡{B_BUFF1} salvaje ha huido!");
...
static const u8 sText_WildFled[] = _("{PLAY_SE 0x11}¡{B_LINK_OPPONENT1_NAME} ha huido!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE 0x11}¡{B_LINK_OPPONENT1_NAME} y\n{B_LINK_OPPONENT2_NAME} han huido!");
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE 0x49}ENCARGADO: ¡No te quedan más\nSAFARI BALLS! ¡Se acabó el tiempo!\p");
static const u8 sText_OpponentMon1Appeared[] = _("{B_OPPONENT_MON1_NAME} appeared!\p"); // Unused
...
static const u8 sText_EmptyString8[] = _(""); // Unused
...
static const u8 sText_GotchaPkmnCaught[] = _("¡Ya está!\n¡{B_OPPONENT_MON1_NAME} atrapado!{WAIT_SE}{PLAY_BGM}À\p");
static const u8 sText_GotchaPkmnCaught2[] = _("¡Ya está!\n¡{B_OPPONENT_MON1_NAME} atrapado!{WAIT_SE}{PLAY_BGM}À{PAUSE 127}");
...
const u8 gText_MoveInterfacePpType[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔPP\nTYPE/");
const u8 gText_MoveInterfaceDynamicColors[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔ");
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔWhich move should\nbe forgotten?");
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔSí\nNo");
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔ¿Cuál\ncambias?");
const u8 gText_BattleSwitchWhich2[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW}ÒÓÔ");
