...
static const u16 sMonMarkings_Pal[] = INCBIN_U16("graphics/interface/mon_markings_menu.gbapal");
static const u8 sMonMarkings_Gfx[] = INCBIN_U8("graphics/interface/mon_markings_menu.4bpp");
