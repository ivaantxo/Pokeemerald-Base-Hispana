...
#define DEBUG_OVERWORLD_MENU            DISABLED_ON_RELEASE     // Habilita un menú de depuración en el mundo exterior para cambiar flags, variables, otorgar Pokémon y más, accesible manteniendo presionado R y presionando START mientras estás en el mundo exterior por defecto.
...
#define DEBUG_BATTLE_MENU               DISABLED_ON_RELEASE     // Si se establece en TRUE, habilita un menú de depuración para usar en batallas al presionar el botón Select.
...
#define DEBUG_POKEMON_SPRITE_VISUALIZER DISABLED_ON_RELEASE    // Habilita un menú de depuración para los sprites e íconos de los Pokémon, accesible al presionar SELECT en la pantalla de resumen.
